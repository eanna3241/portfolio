        ...
        <div className="mx-auto flex max-w-[1400px] flex-col gap-5">
          ...
          <section className="grid grid-cols-[360px_1fr] gap-5">
            <aside className="relative h-[560px] overflow-hidden rounded-[var(--radius-card)] bg-card p-8">
              <div className="h-full overflow-y-auto pr-5 [&::-webkit-scrollbar]:w-[6px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-tag-text">
            ...
            <div className="h-[560px] overflow-y-auto overflow-x-hidden rounded-[var(--radius-card)] p-1">
